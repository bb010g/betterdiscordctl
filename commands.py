...
def initialLog(command_name: str, arguments: argparse.Namespace) -> None:
...
def status(arguments: argparse.Namespace) -> None:
    initialLog(command_name="status", arguments=arguments)


def install(arguments: argparse.Namespace) -> None:
    initialLog(command_name="install", arguments=arguments)


def reinstall(arguments: argparse.Namespace) -> None:
    initialLog(command_name="reinstall", arguments=arguments)


def uninstall(arguments: argparse.Namespace) -> None:
    initialLog(command_name="uninstall", arguments=arguments)


def selfUpgrade(arguments: argparse.Namespace) -> None:
    initialLog(command_name="self-upgrade", arguments=arguments)
